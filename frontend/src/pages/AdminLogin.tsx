...
import { ShieldCheck, Loader2, ArrowLeft, BarChart2, Settings, Lock } from 'lucide-react';
            ...
            <div className="p-8">
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <p className="text-muted-foreground mt-2 text-sm">
                  Manage the Left2Lift platform, view analytics, and oversee all operations.
                </p>
              </div>

              <div className="space-y-3 mb-8">
                {[
                  { icon: BarChart2, text: 'View platform-wide analytics and reports' },
                  { icon: Settings, text: 'Manage users, NGOs, and volunteers' },
