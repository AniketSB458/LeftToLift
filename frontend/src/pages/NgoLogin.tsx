...
import { Heart, Loader2, ArrowLeft, Package, MapPin, Star } from 'lucide-react';
          ...
          <div className="bg-card border border-emerald-200 dark:border-emerald-800 rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="p-8">
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <h1 className="text-2xl font-extrabold text-foreground">NGO / Food Bank Login</h1>
                <p className="text-muted-foreground mt-2 text-sm">
                  Accept food donations and coordinate distribution to communities in need.
                </p>
              </div>
              ...
              <div className="space-y-3 mb-8">
                {[
                  ...
                  { icon: MapPin, text: 'Filter donations by city and location' },
                  { icon: Star, text: 'Rate donors and build trust in the network' },
                ].map(({ icon: Icon, text }) => (
