...
import { Building2, Loader2, ArrowLeft, Utensils, TrendingUp, Heart } from 'lucide-react';
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-card border border-amber-200 dark:border-amber-800 rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <h1 className="text-2xl font-extrabold text-foreground">Hotel / Restaurant Login</h1>
                <p className="text-muted-foreground mt-2 text-sm">
                  Join Left2Lift to donate surplus food and reduce waste across Maharashtra.
                </p>
              </div>
              ...
              <div className="space-y-3 mb-8">
                {[
                  { icon: Utensils, text: 'Post surplus food donations in minutes' },
                  { icon: TrendingUp, text: 'Track your impact and meals saved' },
                  { icon: Heart, text: 'Connect with NGOs and volunteers nearby' },
                ].map(({ icon: Icon, text }) => (
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">
            Secured by{' '}
            <span className="font-semibold text-foreground">Internet Identity</span> — no passwords needed.
          </p>
        </div>
      </main>
    </div>
