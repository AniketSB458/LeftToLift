...
export function useCountdownTimer(expiryTimestampMs: number, totalDurationMs: number): CountdownResult {
  ...
  return { remainingMs, remainingText, percentage, urgencyLevel, urgencyColor, urgencyBorderClass };
}
