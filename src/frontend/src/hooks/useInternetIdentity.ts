...
export function InternetIdentityProvider({
  ...
  // Guard: prevents double-initialization in React StrictMode / fast-refresh
  const initRan = useRef(false);
  // Keep a stable ref to createOptions so the init effect stays dep-free
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: intentionally empty deps — run once on mount only
  useEffect(() => {
